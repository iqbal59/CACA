function Products_Controller(
  ...
  $http
    .get(BASE_URL + "api/custom_fields_by_type/" + "product")
  ...
  $scope.GoToProduct = function (id) {
    ...
    $http
      .get(BASE_URL + "products/get_content/product/" + id)
      .then(function (Data) {
  ...
  $http.get(BASE_URL + "products/get_products").then(function (Products) {
    ...
    $http.get(BASE_URL + "products/get_product_groups").then(function (Groups) {
      $scope.groups = Groups.data;
    });

    $http
      .get(BASE_URL + "products/get_product_categories")
      .then(function (Categories) {
        $scope.category = Categories.data;

        $scope.NewCategory = function () {
          globals.createDialog(
            lang.addProductCategory,
            lang.type_categoryname,
            lang.categoryname,
            "",
            lang.add,
            lang.cancel,
        ...
        $scope.DeleteProductCategory = function (index) {
          ...
          globals.deleteDialog(
            lang.attention,
            lang.confirm_product_category_delete,
            name.id,
            lang.do_it,
            lang.cancel,
            "products/remove_category/" + name.id,
            function (response) {
              if (response.success == true) {
                globals.mdToast("success", response.message);
                $http
        ...
        $scope.deleteProduct = function (PRODUCTID) {
          ...
          $mdDialog.show(confirm).then(
            function () {
              $http
                .post(BASE_URL + "products/remove/" + PRODUCTID, config)
                .then(
                  function (response) {
                    ...
                    $http
                      .get(BASE_URL + "products/get_products")
    ...
    $scope.AddProduct = function () {
      ...
      if (!$scope.product) {
        ...
        var dataObj = $.param({
          ...
          type: $scope.product.producttype,
          group: $scope.product.productgroup,
          format: $scope.product.productformat,
...
function Product_Controller($scope, $http, $mdSidenav, $mdDialog) {
  ...
  $http
    .get(BASE_URL + "api/custom_fields_data_by_type/" + "product/" + PRODUCTID)
    .then(function (custom_fields) {
      $scope.custom_fields = custom_fields.data;
    });

  $http
    .get(BASE_URL + "products/get_product/" + PRODUCTID)
    .then(function (Product) {
      ...
      $scope.Delete = function () {
        ...
        $mdDialog.show(confirm).then(
          function () {
            $http.post(BASE_URL + "products/remove/" + PRODUCTID, config).then(
              function (response) {
                console.log(response);
