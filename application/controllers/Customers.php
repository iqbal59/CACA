...
class Customers extends CIUIS_Controller
{
    ...
    public function customers_arama_json()
    {
    ...
    public function update_contact_privilege($id, $value, $privilege_id)
    {
        if ($this->Privileges_Model->check_privilege('customers', 'edit')) {
            if ($value != 'false') {
                $params = array(
    ...
    public function change_password_contact($id)
    {
        if ($this->Privileges_Model->check_privilege('customers', 'edit')) {
