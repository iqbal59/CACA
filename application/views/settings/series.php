         ...
         <md-card layout="column" class="md-padding" style="margin-left: 1.8%;">
             <md-card-content>
                 ...
                 <div layout="row" layout-wrap>
                     <div flex-gt-xs="50" flex-xs="100">
                         <md-input-container class="md-block">
                             <label><?php echo lang('contact').' '.lang('prefix')?></label>
                             <input ng-model="finance.contact_prefix">
                         </md-input-container>
                     </div>
                     <div flex-gt-xs="50" flex-xs="100">
                         <md-input-container class="md-block">
                             <label><?php echo lang('contact').' '.lang('series')?></label>
                             <input type="number" ng-model="finance.contact_series">
                         </md-input-container>
                     </div>
                 </div>
             </md-card-content>
