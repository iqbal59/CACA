...
<div id="pageContent">
    <div class="ciuis-body-content" ng-controller="Products_Controller">
        ...
        <div class="main-content container-fluid col-xs-12 col-md-9 col-lg-9">
            <md-toolbar class="toolbar-white">
                <div class="md-toolbar-tools">
                    <h2 flex md-truncate class="text-bold"><?php echo lang('products'); ?> <small>(<span
                                ng-bind="products.length"></span>)</small><br>
                        <small flex md-truncate><?php echo lang('productsdescription'); ?></small>
                    </h2>
                    <div class="ciuis-external-search-in-table">
                        <input ng-model="search" class="search-table-external" id="search" name="search" type="text"
            ...
            <md-content ng-show="!productFile" class="md-pt-0 bg-white">
                    ...
                    <table md-table md-progress="promise" ng-cloak>
                        <thead md-head md-order="product_list.order">
                            <tr md-row>
                                ...
                                <th md-column md-order-by="category_name"><span><?php echo lang('category'); ?></span>
                                </th>
                                <th md-column md-order-by="purchase_price">
                                    <span><?php echo lang('purchaseprice'); ?></span>
                                </th>
                        ...
                        <tbody md-body>
                            <tr class="select_row" md-row
                                ng-repeat="product in products | orderBy: product_list.order | limitTo: product_list.limit : (product_list.page -1) * product_list.limit | filter: search | filter: FilteredData"
                                class="cursor" ng-click="GoToProduct(product.product_id)">
                                <td md-cell>
                                    <a class="link" ng-click="GoToProduct(product.product_id)"> <strong
                                            ng-bind="product.product_number"></strong></a><br>
                                ...
                                <td md-cell>
                                    <strong
                                        ng-bind-html="product.purchase_price | currencyFormat:cur_code:null:true:cur_lct"></strong>
                                </td>
                                <td md-cell>
                                    <strong
                                        ng-bind-html="product.price | currencyFormat:cur_code:null:true:cur_lct"></strong>
                                </td>
                                <td md-cell>
                ...
                <md-table-pagination ng-show="products.length > 0" md-limit="product_list.limit"
                    md-limit-options="limitOptions" md-page="product_list.page" md-total="{{products.length}}">
                </md-table-pagination>
                <md-content ng-show="!products.length" class="md-padding no-item-data" ng-cloak>
                ...
                <md-toolbar class="toolbar-white">
                    <div class="md-toolbar-tools">
                        <h2 flex md-truncate class="text-bold"><?php echo lang('productcategory'); ?>
                            <md-button ng-click="CreateCategory()" class="md-icon-button pull-right" aria-label="New"
                                ng-cloak>
                        ...
                        <div class="widget-counter-group widget-counter-group-right">
                            <div style="width: auto" class="pull-left"> <i
                                ...
                                <div class="pull-right" style="text-align: left;margin-top: 10px;line-height: 10px;">
                                    <h4 style="padding: 0px;margin: 0px;"><b><?php echo lang('productbycategory') ?></b>
                                    </h4>
            ...
            <md-content>
                <md-content layout-padding>
                    ...
                    <md-input-container class="md-block">
                        ...
                        <md-select placeholder="Product Type" ng-model="product.producttype" style="min-width: 200px;">
                    ...
                    <md-input-container class="md-block">
                        ...
                        <md-select placeholder="Product Group" ng-model="product.productgroup"
                    ...
                    <md-input-container class="md-block">
                        ...
                        <md-select placeholder="Product Farmat" ng-model="product.productformat"
                            style="min-width: 200px;">
                            ...
                            <md-select-header>
                                <md-toolbar class="toolbar-white">
                                    <div class="md-toolbar-tools">
                                        ...
                                        <md-button class="md-icon-button" ng-click="NewCategory()"
                    ...
                    <md-input-container class="md-block">
                        ...
                        <input required type="number" ng-model="product.purchase_price" class="form-control" id="amount"
                            placeholder="0.00" />
                    </md-input-container>
                    <md-input-container class="md-block">
                        <label><?php echo lang('salesprice') ?></label>
                        <input required type="number" ng-model="product.sale_price" class="form-control" id="amount"
                            placeholder="0.00" />
                    </md-input-container>
                    <md-input-container class="md-block">
                    ...
                    <md-input-container class="md-block">
                        ...
                        <input type="number" ng-model="product.vat" ng-value="0" class="form-control" id="tax"
                            placeholder="<?php echo $appconfig['tax_label']; ?>" />
                    </md-input-container>
                    <md-input-container class="md-block">
                        <label><?php echo lang('instock') ?></label>
                        <input type="number" ng-model="product.stock" ng-value="0" class="form-control" id="stock"
                ...
                <md-content layout-padding>
                    <section layout="row" layout-sm="column" layout-align="center center" layout-wrap>
                        <md-button ng-click="AddProduct()" class="md-raised md-primary pull-right">
                            <?php echo lang('add'); ?></md-button>
                    </section>
                </md-content>
            </md-content>
        </md-sidenav>

        <md-sidenav class="md-sidenav-right md-whiteframe-4dp" md-component-id="CreateCategory" ng-cloak
            style="width: 450px;">
            ...
            <md-content>
                ...
                <md-list-item ng-repeat="name in category" class="noright"
                    ng-click="EditCategory(name.id,name.name, $event)" aria-label="Edit Status"> <strong
                        ng-bind="name.name"></strong>
                    ...
                    <md-icon ng-click='DeleteProductCategory($index)' aria-label="Remove Status"
        ...
        <md-sidenav class="md-sidenav-right md-whiteframe-4dp" md-component-id="ImportProductsNav" ng-cloak
            style="width: 450px;">
            ...
            <md-content>
                ...
                <div class="modal-footer">
                    <a href="<?php echo base_url('uploads/samples/productimport.csv') ?>"
                        class="btn btn-success pull-left"><?php echo lang('downloadsample'); ?></a>
                    <button type="button" ng-click="importProduct()"
