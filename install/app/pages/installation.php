    ...
    <div class="col-sm-12">
      ...
      <form action="./app/controller/Setup_process.php" method="post" id="setupForm">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" required id="hostname" placeholder="Hostname" name="hostname" value="<?= (isset($_POST['hostname']) ? $_POST['hostname'] : 'localhost') ?>">
        </div>
        <!-- USERNAME -->
        <div class="form-group">
          <label for="username">Username</label>
          <input type="text" class="form-control" required id="username" placeholder="Username" name="username" value="<?= (isset($_POST['username']) ? $_POST['username'] : null) ?>">
        </div>
        <!-- PASSWORD -->
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" required id="database" placeholder="Database" name="database" value="<?= (isset($_POST['database']) ? $_POST['database'] : null) ?>">
        </div>
        ...
        ?>
        <div class="form-group">
          <label for="htaccess"><input type="checkbox" id="is_htaccess" name="isHtaccess" value="1"> Htaccess (if you want to add .htacess file in your application then click on this checkbox)</label>
          <div class=" hide">
        ...
        <!-- DUMMY DATA OPTION -->
        <div class="form-group">
          <label for="dummyData"><input type="checkbox" id="is_dummyData" name="isDummyData" value="1"> Dummy data (if you want to add dummy data in your database then click on this checkbox)</label>
        </div>


        <!-- BUTTONS -->
        <div class="divider"></div>
        <a href="?step=requirements" class="btn btn-default left-right text-warning"> <i class="fa fa-backward"></i> Previous</a>
        <div class="pull-right btn-group">
          <button type="reset" class="btn btn-default text-danger">Reset</button>
          <button type="submit" class="btn btn-default text-success text-bold">Install</button>
        </div>
